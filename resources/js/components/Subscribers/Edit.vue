<template>
  <div>
    <div v-show="success"
         class="p-4 mb-4 text-sm text-blue-700 bg-blue-100 rounded-lg dark:bg-blue-200 dark:text-blue-800" role="alert">
    ...
    <form ref="form">
      ...
      <div v-for="(field, index) in lines" :key="index" class="row mb-3">
        <div class="col-lg-4">
        ...
        <div class="col-lg-2">
          <div class="block float-left center align-baseline">
            ...
            <button type="button" v-if="index + 1 === lines.length" @click="addField"
...
export default {
  ...
  methods: {
    addField() {
      let checkEmptyFields = this.lines.filter(field => field.number === null)
      if (checkEmptyFields.length >= 1 && this.lines.length > 0) {
        return
      }
      this.lines.push({
        title: null,
    ...
    update(e) {
      ...
      let component = this;
      window.axios.put('/api/v1/subscribers/' + this.subscriber.id, {
